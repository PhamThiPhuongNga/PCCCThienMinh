            ...
            <div class="auto-container">
                <div class="content-box">
                    ...
                    <ul class="bread-crumb clearfix">
                        ...
                        <li>Dịch vụ</li>
                        <li>Cung cấp phương tiện, thiết bị, vật tư PCCC</li>
                    </ul>
                </div>
            </div>
        </section>
            ...
            <div class="auto-container">
                <div class="row clearfix">
                    <div class="col-lg-4 col-md-12 col-sm-12 sidebar-side">
                        <div class="service-sidebar default-sidebar">
                            ...
                            <div class="sidebar-widget advise-widget">
                                ...
                                <div>
                                    <div class="col-lg-12 col-md-12 col-sm-12 row mb-3 ml-1">
                                        <a class="product-2__frame" href="">
                                            <img src="https://fisavietnam.com/uploads/Vòi chữa cháy TOMOKEN HOSE D50 X 1.6MPA X 20M.jpg" alt="Tính ưu việt của cuộn vòi chữa cháy TOMOKEN HOSE D50 X 1.6MPA X 20M" height="90" width="100" style="
                                            border: 1px solid rgb(227, 227, 227);"></a>
                                        <div class="media-body ml-2">
                                            <h3 class="product-2__name"><a class="title-mini text-dark"href="">Tính ưu việt của cuộn vòi chữa cháy TOMOKEN HOSE D50 X 1.6MPA X 20M</a></h3>
                                            <div class="product__price">
                                            <!--  <a class="button" href="https://fisavietnam.com/tinh-uu-viet-cua-cuon-voi-chua-chay-tomoken-hose-d50-x-1-6mpa-x-20m-pr65">Xem chi tiết</a> -->
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12 content-side">
                        <div>
                            <!-- <div class="text mb-3">
                                <h4 class=""style="left:0; font-weight: 500; font-size:20px; ">CUNG CẤP PHƯƠNG TIỆN, THIẾT BỊ, VẬT TƯ PCCC</h4>
                            </div> -->
