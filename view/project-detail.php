                ...
                <div class="row clearfix">
                    <div class="col-lg-8 col-md-12 col-sm-12 content-side">
                        <div class="service-details-content">
                            <div class="inner-box">
                                <div class="product"><h4>DANH SÁCH SẢN PHẨM</h4></div>
                                <div class="post-info">
                                    <div class=""><i class="fa fa-calendar mr-2"></i>Ngaptp - 10/10/2021</div>
                                    <div>
                                ...
                                <figure class="image-box"><img src="/assets/images/service/service-1.jpg" alt="" height="500px"></figure>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 text">
                        <div class="post-subtitle row">
                            <button type="submit"><span><a href="" class="">Thông tin chi tiết dự án</a></span></button>
                            <button>/</button>
                            <button type="submit"><span><a href="" class="">Hình ảnh thi công</a></span></button>
                        </div>
                        <div>
                            <span><strong>Dự án:</strong> Huyndai Sơn Tây</span></br>
                            <span><strong>Chủ đầu tư:</strong> Công Ty TNHH</span></br>
                            <span><strong>Nội dung công viêc:</strong> Cung cấp, lắp đặt hệ thống PCCC</span>
                        </div>
                        <div class="row">
