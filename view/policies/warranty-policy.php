            ...
            <div class="auto-container">
                <div class="row clearfix">
                            ...
                            <div class="sidebar-widget categori-widget">
                                ...
                                <div class="widget-content">
                                    <ul class="categori-list clearfix">
                                        <li><a href="purchase-policy.php">Chính sách mua hàng</a></li>
                                        <li><a href="return-refund-policy.php">Chính sách đổi trả và hoàn tiền</a></li>
                                        <li><a href="warranty-policy.php"class="active">Chính sách bảo hành</a></li>
                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12 content-side" style="background-color: rgb(255, 239, 239); ">
                        <div>
                            <div class="text mt-3" >
                                <p class="" style="color:red;font-weight: 600;font-size: 20px;">CHÍNH SÁCH BẢO HÀNH</p>   
                            </div>
