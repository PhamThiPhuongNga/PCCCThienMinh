			...
			<div class="sidebar-wrapper scrollbar scrollbar-inner">
				<div class="sidebar-content">
						...
						<div class="info">
							...
							<div class="collapse in" id="collapseExample">
								<ul class="nav">
									<li>
										<a href="#profile">
											<span class="link-collapse">Thông tin hồ sơ</span>
										</a>
									</li>
									<li>
										<a href="#edit">
					...
					<ul class="nav nav-primary">
						<li class="nav-item nabar-dashboard">
								...
								<ul class="nav nav-collapse">
									<li>
										<a href="../sidebar-style-1.html">
											<span class="sub-item">Hệ thống báo cháy</span>
										</a>
									</li>
									<li>
										<a href="../overlay-sidebar.html">
											<span class="sub-item">Hệ thống chữa cháy</span>
										</a>
									</li>
									<li>
										<a href="../compact-sidebar.html">
											<span class="sub-item">Hệ thống tăng áp & hút khói</span>
										</a>
									</li>
									<li>
										<a href="../static-sidebar.html">
											<span class="sub-item">Hệ thống đèn Exit sự cố</span>
										</a>
									</li>
								</ul>
							</div>
						...
						<li class="nav-item navbar-invoice">
								...
								<ul class="nav nav-collapse">
									<li>
										<a href="../maps/jqvmap.html">
											<span class="sub-item">Hóa đơn nhập</span>
										</a>
									</li>
									<li>
										<a href="../maps/jqvmap.html">
											<span class="sub-item">Hóa đơn xuất</span>
										</a>
									</li>
								</ul>
							</div>
						...
						<li class="nav-item navbar-statistical">
